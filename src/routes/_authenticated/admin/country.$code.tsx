...
function ChambersLauncher({ code }: { code: string }) {
  return (
        ...
        {CHAMBERS.map((c) => {
          ...
          return (
            <Link
              key={c.n}
              {...(linkProps as any)}
              className="group relative block border border-line-200 bg-paper-0 p-5 transition hover:-translate-y-0.5 hover:border-ink-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold-500"
            >
              <ArrowUpRight
