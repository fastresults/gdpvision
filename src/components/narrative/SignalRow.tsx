  ...
  return (
    <li className="min-w-0">
      <Link
        ...
        className={cn(
          "block min-w-0 overflow-hidden border border-line-200 border-l-4 px-3 py-2 text-sm text-ink-700 transition hover:border-ink-950",
          meta.borderClass,
      ...
      >
        ...
        <p className="mt-1.5 line-clamp-2 min-w-0 break-words text-sm text-ink-900">{signal.topic}</p>
