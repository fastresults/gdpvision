    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-2 max-w-xl text-sm text-ink-700">
          Frame a plausible disruption to one or more sectors. We&rsquo;ll ground
          the framing in the country&rsquo;s current GDP composition and produce a
          resilient FDI strategy you can stress-test.
        </p>
      </div>
