import illcbi_cliff from "@/assets/illustrations/threat-cbi-cliff.jpg.asset.json";
import illone_storm from "@/assets/illustrations/threat-one-storm.jpg.asset.json";
import illtourism_trap from "@/assets/illustrations/threat-tourism-trap.jpg.asset.json";
import illcut_off from "@/assets/illustrations/threat-cut-off.jpg.asset.json";
import illdebt_ceiling from "@/assets/illustrations/threat-debt-ceiling.jpg.asset.json";
import illpower_cost from "@/assets/illustrations/threat-power-cost.jpg.asset.json";
import illregulated_out from "@/assets/illustrations/threat-regulated-out.jpg.asset.json";
import illtalent_drain from "@/assets/illustrations/threat-talent-drain.jpg.asset.json";
...
export const EXISTENTIAL_THREATS: ExistentialThreat[] = [
  ...
  {
    id: "tourism-trap",
    illustration: illtourism_trap.url,
  ...
  {
    id: "debt-ceiling",
    illustration: illdebt_ceiling.url,
  ...
  {
    id: "power-cost",
    illustration: illpower_cost.url,
  ...
  {
    id: "regulated-out",
    illustration: illregulated_out.url,
  ...
  {
    id: "talent-drain",
    illustration: illtalent_drain.url,
